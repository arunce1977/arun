...
def get_ip_data():
    ...
    input_port = input("What is the port you want ot use?")
    input_priority= input("What is the priority for this entry")
    d = {"IP": input_ip, "driver": input_driver , "port":input_port, "priority":input_priority}
    return d
